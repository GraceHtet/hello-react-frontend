...
**[Hello react front end]** is a front-end simple app that renders random greetings from the backend api.

## [Link to the back-end repo](https://github.com/GraceHtet/hello-rails-backend/tree/rails_api)
...
```sh
  ...
  git clone https://github.com/gracehtet/hello-react-frontend.git
```
...
Feel free to check the [issues page](https://github.com/gracehtet/hello-react-frontend/issues).
